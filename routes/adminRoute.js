...
const { permissionAddValidator, permissionDeleteValidator, permissionUpdateValidator, storeRoleValidator, givePermissionToUser } = require('../helpers/adminValidator');
...
router.post('/give-permission', auth, OnlyAdminCanAccess, permissionController.givePermissionToUser);
